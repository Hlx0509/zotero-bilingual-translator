...
describe('formal release metadata', () => {
  it('keeps manifest, package, and GitHub update metadata on version 1.0.0', async () => {
    ...
    expect(release).toMatchObject({
      version: '1.0.0',
      update_link: 'https://github.com/Hlx0509/zotero-bilingual-translator/releases/download/v1.0.0/zotero-bilingual-translator-1.0.0.xpi',
    });
  });
});
